  ...
  return (
    ...
    >
      <div className="p-6 mx-auto space-y-6 container">
        <header className="flex justify-between">
          ...
          <div>
            <Button variant="ghost" size="icon" asChild className="size-8">
              <a
                href="https://github.com/erich2s/react-mqtt-hooks"
                target="_blank"
                rel="noreferrer"
              >
                <svg viewBox="0 0 438.549 438.549" className="scale-125">
                  <path
                    fill="currentColor"
        ...
        <main className="grid grid-flow-col grid-col-3 gap-4">
          <SingleTopicCard topic="chat/1" />
